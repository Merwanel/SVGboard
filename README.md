...
| | Tests | Coverage |
|---------|-------|----------|
| **Backend** | [![Backend Tests](https://github.com/Merwanel/SVGboard/actions/workflows/backend-tests-push.yml/badge.svg)](https://github.com/Merwanel/SVGboard/actions/workflows/backend-tests-push.yml) | [![codecov](https://codecov.io/gh/Merwanel/SVGboard/branch/main/graph/badge.svg?flag=backend)](https://codecov.io/gh/Merwanel/SVGboard) |
| **Frontend** | [![Frontend Tests](https://github.com/Merwanel/SVGboard/actions/workflows/frontend-tests-push.yml/badge.svg)](https://github.com/Merwanel/SVGboard/actions/workflows/frontend-tests-push.yml) | [![codecov](https://codecov.io/gh/Merwanel/SVGboard/branch/main/graph/badge.svg?flag=frontend)](https://codecov.io/gh/Merwanel/SVGboard) |
